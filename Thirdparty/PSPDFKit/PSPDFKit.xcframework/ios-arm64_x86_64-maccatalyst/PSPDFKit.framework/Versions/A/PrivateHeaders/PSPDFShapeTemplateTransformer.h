...
PSPDF_SDK_CLASS_SWIFT(ShapeTemplateTransformer)
...
/// @param pageInfo The pageInfo for the page on which the the annotation is to be added. Used for setting the annotation's location on the page.
