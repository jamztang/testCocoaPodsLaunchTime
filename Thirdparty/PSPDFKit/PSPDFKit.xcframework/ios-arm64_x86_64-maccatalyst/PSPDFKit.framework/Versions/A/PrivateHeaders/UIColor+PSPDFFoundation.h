...
+ (nullable UIColor *)pspdf_colorWithHexString:(NSString *)colorString;
...
- (BOOL)pspdf_getHue:(nullable CGFloat *)hue saturation:(nullable CGFloat *)saturation lightness:(nullable CGFloat *)lightness alpha:(nullable CGFloat *)alpha;
