...
@property (nonatomic, readonly) BOOL useFileCoordination;
...
- (BOOL)queue_performAdditonalSaveActionsFor:(nullable NSArray<__kindof PSPDFAnnotation *> *)savedAnnotations didSave:(BOOL)didSave error:(NSError *__autoreleasing *)error;
...
/// A set of known `PSPDFDataProviding` classes.
