...
- (void)finishSetupWithAttachmentResolver:(id<PSPDFInstantAnnotationAttachmentResolver>)attachmentResolver propertyAccessQueue:(PSPDFDispatchQueue<PSPDFCustomConcurrentQueue> *)accessQueue;
...
#pragma mark - PSPDFAnnotation Additions
