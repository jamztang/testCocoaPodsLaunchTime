...
@property (class, readonly) NSBundle *pspdf_modelBundle;

/// Bundle containing the PSPDFKitUI asset catalog.
@property (class, readonly, nullable) NSBundle *pspdf_UIBundle;

/// Calls through to `localizedStringForKey:value:table:` but returns `nil` if the key is not found.
- (nullable NSString *)pspdf_localizedStringForKey:(NSString *)key table:(nullable NSString *)tableName NS_FORMAT_ARGUMENT(1);
