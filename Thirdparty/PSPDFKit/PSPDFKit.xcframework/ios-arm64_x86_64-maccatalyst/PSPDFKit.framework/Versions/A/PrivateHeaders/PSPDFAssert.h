...
#define PSPDFAssertEnumerable(enumerable, allowedClass) PSPDFCheckAllowedClassThrows((enumerable), [allowedClass class])
...
#define PSPDFAssertClass(object, allowedClass)                                                                                                                                                                                \
    do {                                                                                                                                                                                                                      \
        NSAssert([object isKindOfClass:[allowedClass class]], @"Object type not satisfying: '%@' must be of type '%s' but is '%@'.", object, #allowedClass, PSPDFClassStringFromObject(object)); \
    } while (0)
...
#define PSPDFAssertClassOptional(object, allowedClass)                                                                                                                                                                   \
    do {                                                                                                                                                                                                                 \
        NSAssert(object == nil || [object isKindOfClass:[allowedClass class]], @"Object type not satisfying: '%@' must be of type '%@' or nil but is '%@'.", object, NSStringFromClass([allowedClass class]), PSPDFClassStringFromObject(object)); \
    } while (0)
...
#define PSPDFCAssertClass(object, allowedClass)                                                                                                                                                         \
    do {                                                                                                                                                                                                \
        NSCAssert([object isKindOfClass:[allowedClass class]], @"Object type not satisfying: '%@' must be of type '%@' but is '%@'.", object, NSStringFromClass([allowedClass class]), PSPDFClassStringFromObject(object)); \
    } while (0)

#define PSPDFCAssertClassOptional(object, allowedClass)                                                                                                                                                                   \
    do {                                                                                                                                                                                                                  \
        NSCAssert(!object || [object isKindOfClass:[allowedClass class]], @"Object type not satisfying: '%@' must be of type '%@' or nil but is '%@'.", object, NSStringFromClass([allowedClass class]), PSPDFClassStringFromObject(object)); \
    } while (0)
...
#define PSPDFAssertOnSubclassOverridesSelector(theClass, selector) \
    ({ NSAssert(!PSPDFSubclassOverridesSelector(theClass, self, selector), @"Subclass %@ must not override %@ method. See https://pspdfkit.com/guides/ios/current/getting-started/overriding-classes/ for details.", NSStringFromClass(self), NSStringFromSelector(selector)); })
