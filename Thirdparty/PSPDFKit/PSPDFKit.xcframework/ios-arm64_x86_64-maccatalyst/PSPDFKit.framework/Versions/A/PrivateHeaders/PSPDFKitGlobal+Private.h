...
// feature flags
#define PSPDFEnableUndoFeature 1 // Enable Undo/Redo feature.
...
/// Set before the framework is initialized. Will require less memory but operates slower.
PSPDF_APP_EXPORT PSPDFSettingKey const PSPDFSettingKeyLowMemoryMode;
...
/// Enables the selection loupe.
PSPDF_APP_EXPORT PSPDFSettingKey const PSPDFSettingKeyLoupeEnabled;
...
///
/// This feature is enabled by default and especially effective on modern hardwware
