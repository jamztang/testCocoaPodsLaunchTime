...
/// Resolves paths like "Documents", "Bundle" or "PSBundle" to their real path.
...
/// "Bundle" resolves to the host app bundle. "PSBundle" can be used for paths inside the library bundle.
...
PSPDF_TEST_EXPORT BOOL PSPDFIsRootPath(NSString *path);
