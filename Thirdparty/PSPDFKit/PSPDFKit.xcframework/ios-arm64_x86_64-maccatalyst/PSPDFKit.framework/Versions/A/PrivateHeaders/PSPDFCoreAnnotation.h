...
// See PSPDFCoreAnnotation+Private.hpp for the actual initializer. We don't want to include it here to not C++ everything.
...
#pragma mark Accessing Core Properties
...
#pragma mark Generating Instant JSON:
...
#pragma mark Managing Instant JSON Attachments:
...
- (BOOL)attachBinaryInstantJSONAttachmentFromDataProvider:(id<PSPDFDataProviding>)dataProvider mimeType:(nullable NSString *)mimeType error:(NSError **)error;
