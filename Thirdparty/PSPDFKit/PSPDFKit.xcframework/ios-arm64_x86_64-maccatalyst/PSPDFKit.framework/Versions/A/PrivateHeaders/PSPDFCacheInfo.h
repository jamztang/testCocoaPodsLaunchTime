...
/// @return A newly initialized cache info
...
@interface PSPDFCacheInfo (Deprecated)

+ (nullable instancetype)cacheInfoForRequest:(PSPDFRenderRequest *)request PSPDF_DEPRECATED(9.1, 4.1, "Use `initWithRequest:error:` instead.") NS_SWIFT_UNAVAILABLE("Use version with error handling");
