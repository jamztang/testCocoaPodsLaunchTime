...
@property (nonatomic, readonly) NSDictionary<NSString *, ObjectType> *pspdf_caseInsensitiveDictionary;

/// Inverts a dictionary. Duplicate values will result in a random value winning as key.
@property (nonatomic, readonly) NSDictionary<ObjectType, KeyType> *pspdf_invertedDictionary;
...
/// Workaround for `instancetype` not being available to annotations.
+ (NSMutableDictionary<NSString *, NSString *> *)pspdf_dictionaryWithQuery:(nullable NSString *)queryString;
