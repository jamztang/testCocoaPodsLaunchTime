...
/// See https://pspdfkit.com/guides/ios/current/getting-started/permissions/#toc_microphone-permissions for futher documentation.
...
#pragma mark Customizing the Appearance

/// The sound icon name.
@property (atomic, copy, nullable) NSString *iconName;

#pragma mark Determining Capabilities
...
#pragma mark Accessing the Audio Metadata
...
#pragma mark Accessing the Audio Data
...
#pragma mark Creating Instances from a Sound File
...
#pragma mark Creating Instances by Recording a Sound
...
- (instancetype)initWithRecorder NS_SWIFT_UNAVAILABLE("Use init(recorderOptions:) with the default `nil` recorder options") PSPDF_DEPRECATED(9.3, 4.2, "Please use initWithRecorderOptions: with a nil parameter instead.");
