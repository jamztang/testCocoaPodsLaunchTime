...
PSPDF_EXPORT NSString *const PSPDFDocumentCheckpointSavedNotificationSucessKey PSPDF_DEPRECATED(10.1, 5.0, "Please use `PSPDFDocumentCheckpointSavedNotificationSuccessKey`");
