...
#pragma mark Options for the Object Finder.
...
#pragma mark Object Finder Output Types.
...
#pragma mark Object Finder Methods
...
PSPDF_EXPORT NSString *const PSPDFObjectsGlyphsKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionExtractGlyphs` or `PSPDFObjectFinderTypeGlyphs` instead.");
PSPDF_EXPORT NSString *const PSPDFObjectsWordsKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionExtractWords` or `PSPDFObjectFinderTypeWords` instead.");
PSPDF_EXPORT NSString *const PSPDFObjectsTextKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionExtractText` or `PSPDFObjectFinderTypeText` instead.");
PSPDF_EXPORT NSString *const PSPDFObjectsTextBlocksKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionExtractTextBlocks` or `PSPDFObjectFinderTypeTextBlocks` instead.");
PSPDF_EXPORT NSString *const PSPDFObjectsImagesKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionExtractImages` or `PSPDFObjectFinderTypeImages` instead.");
PSPDF_EXPORT NSString *const PSPDFObjectsAnnotationsKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionExtractAnnotations` or `PSPDFObjectFinderTypeAnnotations` instead.");

PSPDF_EXPORT NSString *const PSPDFObjectsIgnoreLargeTextBlocksKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionIgnoreLargeTextBlocks` instead.");
PSPDF_EXPORT NSString *const PSPDFObjectsAnnotationTypesKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionAnnotationTypes` instead.");
PSPDF_EXPORT NSString *const PSPDFObjectsAnnotationPageBoundsKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionAnnotationPageBounds` instead.");
PSPDF_EXPORT NSString *const PSPDFObjectsPageZoomLevelKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionPageZoomLevel` instead.");
PSPDF_EXPORT NSString *const PSPDFObjectsAnnotationIncludedGroupedKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionAnnotationIncludedGrouped` instead.");
PSPDF_EXPORT NSString *const PSPDFObjectsSmartSortKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionSmartSort` instead.");
PSPDF_EXPORT NSString *const PSPDFObjectMinDiameterKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionMinDiameter` instead.");
PSPDF_EXPORT NSString *const PSPDFObjectsTextFlowKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionTextFlow` instead.");
PSPDF_EXPORT NSString *const PSPDFObjectsFindFirstOnlyKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionFindFirstOnly` instead.");
PSPDF_EXPORT NSString *const PSPDFObjectsTestIntersectionKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionTestIntersection` instead.");
PSPDF_EXPORT NSString *const PSPDFObjectsTestIntersectionFractionKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFObjectFinderOptionTestIntersectionFraction` instead.");
