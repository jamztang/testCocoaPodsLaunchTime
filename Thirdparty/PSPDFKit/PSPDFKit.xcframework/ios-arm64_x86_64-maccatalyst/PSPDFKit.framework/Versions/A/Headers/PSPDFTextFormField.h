...
/// Inserts a new `PSPDFTextFormField` into the document.
///
...
///
/// @note Evaluates `PSPDFTextFieldFlagComb` in the `fieldFlags`.
/// @warning Most flags aren't currently supported. Query `fieldFlags` from the `PSPDFFormElement` base class.
...
///
/// @note Evaluates `PSPDFTextFieldFlagDoNotScroll` in the `fieldFlags`.
@property (nonatomic) BOOL doNotScroll;

/// (PDF 1.5) If set, the value of this field shall be a rich text string (see 12.7.3.4, “Rich Text Strings”). If the field has a value, the RV entry of the field dictionary (Table 222) shall specify the rich text string.
///
/// @note Evaluates `PSPDFTextFieldFlagRichText` in the `fieldFlags`.
/// @warning Most flags aren't currently supported. Query `fieldFlags` from the `PSPDFFormElement` base class.
@property (nonatomic) BOOL isRichText;

/// (PDF 1.4) If set, text entered in the field shall not be spell-checked.
///
/// @note Evaluates `PSPDFTextFieldFlagDoNotSpellCheck` in the `fieldFlags`.
/// @warning Most flags aren't currently supported. Query `fieldFlags` from the `PSPDFFormElement` base class.
@property (nonatomic) BOOL doNotSpellCheck;

/// (PDF 1.4) If set, the text entered in the field represents the pathname of a file whose contents shall be submitted as the value of the field.
///
/// @note Evaluates `PSPDFTextFieldFlagFileSelect` in the `fieldFlags`.
/// @warning Most flags aren't currently supported. Query `fieldFlags` from the `PSPDFFormElement` base class.
