...
///
/// @note This method being called does not necesarily mean that the processing itself has stopped altogether, but that the cancellation has been requested and will happen sometime in the future.
///
