...
PSPDF_CLASS_SWIFT(SearchResult)
@interface PSPDFSearchResult : PSPDFModel

/// Designated initializer.
- (instancetype)initWithDocumentUID:(NSString *)documentUID pageIndex:(PSPDFPageIndex)pageIndex range:(NSRange)range previewText:(NSString *)previewText rangeInPreviewText:(NSRange)rangeInPreviewText selection:(nullable PSPDFTextBlock *)selection annotation:(nullable PSPDFAnnotation *)annotation NS_DESIGNATED_INITIALIZER;
