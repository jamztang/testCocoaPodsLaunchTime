...
PSPDF_EXPORT BOOL PSPDFDrawingPointIsValid(PSPDFDrawingPoint point) PSPDF_SWIFT_NAME("getter:DrawingPoint.isValid(self:)") PSPDF_PURE PSPDF_DEPRECATED(10.0, 5.0, "Use `PSPDFDrawingPointIsFinite` instead.");
