...
///
/// @return A newly initialized instance of the receiver. If an error occurs, this method returns `nil` while setting the out `error` parameter to the encountered error.
