...
/// An implementation of `PSPDFDataProviding` that acts upon a file. All file access is coordinated
/// with file coordination (`NSFileCoordinator`).
/// This class implements the optional conflict resolution methods of `PSPDFCoordinatedFileDataProviding`.
