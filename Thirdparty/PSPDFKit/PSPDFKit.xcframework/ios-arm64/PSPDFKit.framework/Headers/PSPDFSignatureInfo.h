...
/// An array of pairs of integers (wrapped as NSNumber, starting byte offset, ending byte offset) that shall describe the exact byte range for the digest calculation.
...
@property (nonatomic, copy, readonly, nullable) NSArray<NSNumber *> *byteRange NS_REFINED_FOR_SWIFT;
