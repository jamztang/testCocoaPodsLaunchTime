...
/// extracted from the matching documents and a dictionary of UID->`NSSet` of `PSPDFLibraryPreviewResult`s will
...
/// @param previewTextHandler The block to execute with a text preview argument for all the search results. A dictionary of UID -> `NSSet<PSPDFLibraryPreviewResult *>` objects will be passed in as the argument.
///
...
#pragma mark Indexing Operations
...
/// Removes the indexed contents for document with a matcing `UID`.
///
...
PSPDF_EXPORT NSString *const PSPDFLibraryMaximumSearchResultsTotalKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFLibraryOptionMaximumSearchResultsTotal` instead.");
PSPDF_EXPORT NSString *const PSPDFLibraryMaximumSearchResultsPerDocumentKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFLibraryOptionMaximumSearchResultsPerDocument` instead.");
PSPDF_EXPORT NSString *const PSPDFLibraryMaximumPreviewResultsTotalKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFLibraryOptionPreviewResultsTotal` instead.");
PSPDF_EXPORT NSString *const PSPDFLibraryMaximumPreviewResultsPerDocumentKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFLibraryOptionMaximumPreviewResultsPerDocument` instead.");
PSPDF_EXPORT NSString *const PSPDFLibraryMatchExactWordsOnlyKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFLibraryOptionMatchExactWordsOnly` instead.");
PSPDF_EXPORT NSString *const PSPDFLibraryMatchExactPhrasesOnlyKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFLibraryOptionMatchExactPhrasesOnly` instead.");
PSPDF_EXPORT NSString *const PSPDFLibraryExcludeAnnotationsKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFLibraryOptionExcludeAnnotations` instead.");
PSPDF_EXPORT NSString *const PSPDFLibraryExcludeDocumentTextKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFLibraryOptionExcludeDocumentText` instead.");
PSPDF_EXPORT NSString *const PSPDFLibraryPreviewRangeKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED(9.4, 4.4, "Use `PSPDFLibraryOptionPreviewRange` instead.");
