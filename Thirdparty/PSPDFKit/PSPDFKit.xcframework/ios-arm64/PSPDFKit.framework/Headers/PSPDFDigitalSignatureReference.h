...
typedef NS_CLOSED_ENUM(NSUInteger, PSPDFDigitalSignatureReferenceTransformMethod) {
...
} PSPDF_ENUM_SWIFT(DigitalSignatureReference.TransformMethod);

/// @note Requires the `Features.digitalSignatures` feature flag.
PSPDF_CLASS_SWIFT(DigitalSignatureReference)
