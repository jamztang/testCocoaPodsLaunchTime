...
PSPDF_CLASS_SWIFT(ModelObject)
@interface PSPDFModel : NSObject<NSCopying>

/// Returns a new instance of the receiver initialized using
/// -initWithDictionary:error:.
+ (nullable instancetype)modelWithDictionary:(nullable NSDictionary<NSString *, id> *)dictionaryValue error:(NSError * __autoreleasing _Nullable *)error;
...
- (nullable instancetype)initWithDictionary:(nullable NSDictionary<NSString *, id> *)dictionaryValue error:(NSError * __autoreleasing _Nullable *)error;
