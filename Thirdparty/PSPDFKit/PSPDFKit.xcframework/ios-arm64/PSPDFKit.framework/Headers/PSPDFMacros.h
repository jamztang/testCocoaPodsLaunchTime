...
// Deprecation/Availability helper
#if TARGET_OS_OSX
...
#define PSPDF_UNAVAILABLE_MAC PSPDF_UNAVAILABLE("Not available in PSPDFKit for macOS")
#define PSPDF_DEPRECATED_IOS(iOSVersion, msg) PSPDF_UNAVAILABLE_MAC
#else
...
#define PSPDF_UNAVAILABLE(message) __attribute__((unavailable(message)))
