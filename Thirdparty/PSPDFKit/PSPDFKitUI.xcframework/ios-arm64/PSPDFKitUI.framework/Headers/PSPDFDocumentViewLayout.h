...
/// other behaviours, such as how zooming behaves (`spreadBasedZooming`), how spreads
...
#pragma mark Managing Spreads and Pages
...
/// availbale as well to read and modify the spread index.
///
/// @warning When subclassing `PSPDFDocumentViewLayout` directly, you need to implement
/// this method and do not call super. The base implementatio of this method
/// throws an exception.
///
...
///
/// @note While `invalidateLayout` handels the invalidation of the spreads positions,
/// this method handles the overall configuration related to the document view.
- (void)invalidateConfiguration;

#pragma mark Unavalaible Inherited API
...
///
/// This is a layout that scrolls through spreads and pages continuously, whithout
