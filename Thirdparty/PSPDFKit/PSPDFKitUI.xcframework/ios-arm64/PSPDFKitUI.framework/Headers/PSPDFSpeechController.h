...
PSPDF_EXPORT NSString *const PSPDFSpeechSynthesizerAutoDetectLanguage NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED_IOS(9.4, "Use `PSPDFSpeechControllerOptionAutoDetectLanguage` instead.");
PSPDF_EXPORT NSString *const PSPDFSpeechSynthesizerLanguageKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED_IOS(9.4, "Use `PSPDFSpeechControllerOptionLanguage` instead.");
PSPDF_EXPORT NSString *const PSPDFSpeechSynthesizerLanguageHintKey NS_SWIFT_UNAVAILABLE("") PSPDF_DEPRECATED_IOS(9.4, "Use `PSPDFSpeechControllerOptionLanguageHint` instead.");
