...
PSPDF_EXPORT NSString *const PSPDFPresentationStyleKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFPresentationOptionPresentationStyle` instead.");
PSPDF_EXPORT NSString *const PSPDFPresentationHalfModalStyleKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFPresentationOptionHalfModalStyle` instead.");
PSPDF_EXPORT NSString *const PSPDFPresentationNonAdaptiveKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFPresentationOptionNonAdaptive` instead.");
PSPDF_EXPORT NSString *const PSPDFPresentationRectBlockKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFPresentationOptionSourceRectProvider` instead.");
PSPDF_EXPORT NSString *const PSPDFPresentationContentSizeKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFPresentationOptionContentSize` instead.");
PSPDF_EXPORT NSString *const PSPDFPresentationInNavigationControllerKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFPresentationOptionInNavigationController` instead.");
PSPDF_EXPORT NSString *const PSPDFPresentationCloseButtonKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFPresentationOptionCloseButton` instead.");
PSPDF_EXPORT NSString *const PSPDFPresentationReuseNavigationControllerKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFPresentationOptionReuseNavigationController` instead.");
PSPDF_EXPORT NSString *const PSPDFPresentationPopoverArrowDirectionsKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFPresentationOptionPopoverArrowDirections` instead.");
PSPDF_EXPORT NSString *const PSPDFPresentationPopoverPassthroughViewsKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFPresentationOptionPopoverPassthroughViews` instead.");
PSPDF_EXPORT NSString *const PSPDFPresentationPopoverBackgroundColorKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFPresentationOptionPopoverBackgroundColor` instead.");
PSPDF_EXPORT NSString *const PSPDFPresentationRectKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFPresentationOptionSourceRect` instead.");
