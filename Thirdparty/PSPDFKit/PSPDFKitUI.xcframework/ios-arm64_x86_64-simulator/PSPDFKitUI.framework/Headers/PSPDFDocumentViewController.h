...
#pragma mark Continuous Spread Index
...
/// Controls whether the view responsible for scrolling should show a scroll indicator
/// or not.
///
/// Defaults to `false` when the layout uses spread-based zooming, otherwise `true`.
@property (nonatomic) BOOL showsScrollIndicator;

#pragma mark Spread Views
...
/// Asks the document view controller for a visible page view at the given location.
///
/// @param point Location of a potential page view, in the coordinate space of the
/// document view controller's view.
///
/// @return A page view that is visible at the given location, or `nil`.
