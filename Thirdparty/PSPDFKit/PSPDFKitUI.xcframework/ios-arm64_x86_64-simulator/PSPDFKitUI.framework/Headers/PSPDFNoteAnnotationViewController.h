...
///
/// Comments means the `contents` of the annotation and, if enabled, the `contents` of all replies to that annotation.
/// Whether replies are enabled is determined by the `canShowAnnotationReplies` feature from `PSPDFDocumentFeatures`.
///
