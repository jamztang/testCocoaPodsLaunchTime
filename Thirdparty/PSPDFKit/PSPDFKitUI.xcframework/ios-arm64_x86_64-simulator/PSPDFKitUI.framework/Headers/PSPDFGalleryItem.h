...
#pragma mark PSPDFGalleryItem Dictionary Keys
...
PSPDF_EXPORT NSString *const PSPDFGalleryItemTypeKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFGalleryItemPropertyType` instead.");
PSPDF_EXPORT NSString *const PSPDFGalleryItemContentURLKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFGalleryItemPropertyContentURL` instead.");
PSPDF_EXPORT NSString *const PSPDFGalleryItemCaptionKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFGalleryItemPropertyCaption` instead.");
PSPDF_EXPORT NSString *const PSPDFGalleryItemOptionsKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFGalleryItemPropertyOptions` instead.");
