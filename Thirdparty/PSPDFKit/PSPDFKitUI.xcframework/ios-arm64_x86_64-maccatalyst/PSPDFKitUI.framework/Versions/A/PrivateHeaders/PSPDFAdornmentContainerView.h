...
#pragma mark Associated Types/Forward Declarations
...
PSPDF_PROTOCOL_SWIFT(ScrubberBarAdornment)
...
PSPDF_APP_CLASS_SWIFT(AdornmentContainerView)
...
/// @note If you update the view’s frame, be aware that _only chages in size_ will be preserved.
...
PSPDF_PROTOCOL_SWIFT(ScrubberBarAdornmentSource)
