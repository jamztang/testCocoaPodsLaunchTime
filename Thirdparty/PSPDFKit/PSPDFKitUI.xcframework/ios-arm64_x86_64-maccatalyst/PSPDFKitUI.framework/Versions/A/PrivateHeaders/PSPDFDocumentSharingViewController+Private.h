...
@class PSPDFConfiguration, PSPDFDocumentSharingTableViewData, PSPDFDocumentSharingProcessingManager, MFMailComposeViewController;
...
#pragma mark Destinations Support
...
///
/// Useful to skip the configuration UI for cases like `PSPDFOpenInActivity.mm`.
