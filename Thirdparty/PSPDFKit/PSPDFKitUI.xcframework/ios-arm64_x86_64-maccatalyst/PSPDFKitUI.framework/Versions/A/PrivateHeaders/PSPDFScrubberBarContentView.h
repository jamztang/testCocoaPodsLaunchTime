...
@class PSPDFScrubberBarContentView, PSPDFScrubberBar;
...
/// Inferred from the dataSource by default.
@property (nonatomic, nullable) UIToolbarAppearance *standardAppearance UI_APPEARANCE_SELECTOR API_AVAILABLE(ios(13));

/// Appearance style to be used by the for the compact height toolbar.
/// Inferred from the dataSource by default.
@property (nonatomic, nullable) UIToolbarAppearance *compactAppearance UI_APPEARANCE_SELECTOR API_AVAILABLE(ios(13));
