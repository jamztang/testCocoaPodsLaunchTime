...
/// Returns the acitivites suitable for the configuration after applying the configuration block.
- (NSArray<UIActivity *> *)applicationUIActivities:(void (^)(UIActivity *))configure;
...
/// viable to take into consideration given the current sharing context.
///
/// Use case: remove the ability to embed annotations in to the document if there licence does not include that component.
...
///
/// The appropriate option is determined via importance level. Read more: https://pspdfkit.com/guides/ios/current/miscellaneous/document-sharing/#sharing-configurations
...
///
/// Read more: https://pspdfkit.com/guides/ios/current/miscellaneous/document-sharing/#sharing-configurations
