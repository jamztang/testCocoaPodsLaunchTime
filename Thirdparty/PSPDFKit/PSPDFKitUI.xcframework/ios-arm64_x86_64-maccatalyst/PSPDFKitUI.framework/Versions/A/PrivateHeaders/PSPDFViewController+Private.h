...
@class PSPDFPage, PSPDFLinkAnnotationView, PSPDFAnnotationViewCache, PSPDFScrollView, PSPDFAction, PSPDFKeyboardHandlingView, PSPDFViewControllerView, PSPDFViewModeCoordinator, PSPDFDocument, PSPDFPageView, PSPDFSoundAnnotationPlaybackCoordinator, PSPDFDigitalSignatureCoordinator, PSPDFJSPlatformDelegateAdapter, PSPDFPresentationManager, PSPDFDefaultApplication, PSPDFJSPrintParams;
...
PSPDF_EXTERN NSNotificationName const PSPDFViewControllerDidChangeConfigurationNotification;
...
/// Return all selected annotations from all pages.
/// When setting annotations, only one `PDFPageView` can be active. All other annotations will be ignored.
/// All set selected annotations must be on the same page view.
@property (nonatomic, copy) NSArray<__kindof PSPDFAnnotation *> *selectedAnnotations;
...
#pragma mark user interface show/hide
...
///
/// Use this for the page grabber and other similar elements.
