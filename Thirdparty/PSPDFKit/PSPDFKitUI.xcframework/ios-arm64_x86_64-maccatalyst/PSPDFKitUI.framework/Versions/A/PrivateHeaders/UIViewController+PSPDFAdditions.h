...
/// isModalInPresentation on iOS 13 and later, or isModalInPopover on earlier versions.
@property (nonatomic, getter=pspdf_isModalInPresentation, setter=pspdf_setModalInPresentation:) BOOL pspdf_modalInPresentation;
...
- (nullable __kindof UIViewController *)pspdf_closestChildViewControllerOfClass:(Class)controllerClass;
