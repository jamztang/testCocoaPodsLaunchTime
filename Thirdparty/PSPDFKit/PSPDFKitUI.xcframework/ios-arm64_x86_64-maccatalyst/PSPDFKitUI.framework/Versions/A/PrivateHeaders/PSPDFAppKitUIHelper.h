...
+ (void)showPanelWithFileName:(NSString *)fileName allowedFileExtensions:(NSArray *)allowedFileExtensions completionHandler:(void(^)(NSURL *_Nullable targetURL))completionHandler;
