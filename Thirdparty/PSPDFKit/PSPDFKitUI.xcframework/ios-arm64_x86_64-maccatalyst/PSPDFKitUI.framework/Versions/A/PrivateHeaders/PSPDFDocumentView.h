...
/// @return A newly initialized document view.
- (instancetype)initWithFrame:(CGRect)frame layout:(PSPDFDocumentViewLayout *)layout NS_DESIGNATED_INITIALIZER;
...
///
/// This is an integer integer representation of the `continuousSpreadIndex` for convenience.
///
