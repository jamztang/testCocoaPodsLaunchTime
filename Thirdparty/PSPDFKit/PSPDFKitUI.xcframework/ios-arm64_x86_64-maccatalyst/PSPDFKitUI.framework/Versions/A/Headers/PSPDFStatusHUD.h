...
- (void)pushAnimated:(BOOL)animated onWindow:(nullable UIWindow *)window completion:(nullable void (^)(void))completion;
...
+ (void)popAllItemsAnimated:(BOOL)animated forHUDOnWindow:(nullable UIWindow *)window completion:(nullable void (^)(void))completion;
