...
PSPDF_EXPORT NSNotificationName const PSPDFNetworkActivityDidStartNotification;

/// Posted whenever any network activity in PSPDFKit finishes (that is, either completes or fails).
PSPDF_EXPORT NSNotificationName const PSPDFNetworkActivityDidFinishNotification;

/// The network indicator manager will track the number of currently open network request.
PSPDF_PROTOCOL_SWIFT(NetworkActivityIndicatorManager)
...
PSPDF_CLASS_SUBCLASSING_RESTRICTED_SWIFT(DefaultNetworkActivityIndicatorManager)
