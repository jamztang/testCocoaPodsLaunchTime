...
typedef NS_OPTIONS(NSUInteger, PSPDFImageQuality) {
    ...
    /// Deprecated alias for `PSPDFImageQualityBest`.
    PSPDFImageQualityHigh PSPDF_DEPRECATED_IOS(9.2, "Please use PSPDFImageQualityBest instead.") = PSPDFImageQualityBest,
...
///
/// @note Make sure you configured Image Permissions in your app for the specified source type. Otherwise, they will be ignored.
/// See https://pspdfkit.com/guides/ios/current/getting-started/permissions/#toc_image-permissions for further documentation.
