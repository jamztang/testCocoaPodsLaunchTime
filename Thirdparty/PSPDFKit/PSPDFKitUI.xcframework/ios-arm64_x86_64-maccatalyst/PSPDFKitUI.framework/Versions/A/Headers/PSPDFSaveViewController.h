...
@class PSPDFDirectory, PSPDFSaveViewController, PSPDFDocumentEditorConfiguration;
...
///
/// Will show a `UIDocumentPickerViewController` if `saveDirectories` contains `PSPDFDirectory.documentPickerDirectory`,
...
/// @return A new directory save view controller instance.
