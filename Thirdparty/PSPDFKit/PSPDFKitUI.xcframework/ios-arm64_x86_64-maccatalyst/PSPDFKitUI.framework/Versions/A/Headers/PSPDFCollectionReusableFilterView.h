...
typedef NS_CLOSED_ENUM(NSInteger, PSPDFCollectionReusableFilterViewStyle) {
    /// Standard view.
...
} PSPDF_ENUM_SWIFT(CollectionReusableFilterView.Style);
...
PSPDF_CLASS_SWIFT(CollectionReusableFilterView)
