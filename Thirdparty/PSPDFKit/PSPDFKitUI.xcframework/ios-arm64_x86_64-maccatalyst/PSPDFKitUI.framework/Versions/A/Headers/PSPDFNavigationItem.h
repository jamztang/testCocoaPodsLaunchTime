...
/// @param animated       `true` if you want to animate the change. This value is only of relevance if the passed in `viewMode` is the current view mode.
...
/// @param animated `true` if you want the change for the current view mode to be animated.
