...
@protocol PSPDFViewControllerDelegate, PSPDFAnnotationSetStore, PSPDFFormSubmissionDelegate, PSPDFDocumentViewInteractions;
@class PSPDFDocument, PSPDFScrollView, PSPDFPageView, PSPDFRelayTouchesView, PSPDFPageViewController, PSPDFSearchResult, PSPDFViewState, PSPDFPageLabelView, PSPDFDocumentLabelView, PSPDFAnnotationViewCache, PSPDFAnnotationStateManager, PSPDFSearchHighlightViewManager, PSPDFAction, PSPDFAnnotationToolbar, PSPDFDocumentViewController, PSPDFThumbnailViewController, PSPDFAnnotationToolbarController, PSPDFDocumentInfoCoordinator, PSPDFAppearanceModeManager, PSPDFBrightnessManager,
...
#pragma mark Initialization and essential properties.
...
#pragma mark View State Restoration
...
///
/// The getter returns `nil` if `isPageGrabberEnabled` is set to `false` in the configuration.
///
...
///
/// @note This will only scroll inside the current page when using page curl transitions.
...
#pragma mark Presenting embedded files
...
/// Presents the `OutlineViewController` if there is an outline defined in the PDF.
///
...
/// Presents the `BrightnessViewController` to control screen brightness.
///
...
/// Presents the `PDFSettingsViewContoller` to control some aspects of PSPDFViewController UX.
...
#pragma mark Customizing the User Interactions
...
/// Annotation selection will be cleared.
///
/// @param pageIndex The index of the page in the document to be reloaded.
/// @param animated Whether to animate the view updates.
- (void)reloadPageAtIndex:(PSPDFPageIndex)pageIndex animated:(BOOL)animated PSPDF_DEPRECATED_IOS(10.1, "Please use `reloadPages(indexes:animated:)` instead.");


PSPDF_EXPORT NSString *const PSPDFViewControllerSearchHeadlessKey PSPDF_DEPRECATED_IOS(9.3, "Please use `PSPDFPresentationOptionSearchHeadless` instead.");
