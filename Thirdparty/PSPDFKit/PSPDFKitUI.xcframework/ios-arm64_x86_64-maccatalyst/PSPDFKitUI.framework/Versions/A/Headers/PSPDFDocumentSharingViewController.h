...
/// Called when the sharing configuration UI is dimsissed by the user.
...
/// @param progress            The progress of the total file crunching, reprecented from 0 to 1.
...
@interface PSPDFDocumentSharingViewController : PSPDFStaticTableViewController<PSPDFStyleable, PSPDFOverridable>
...
///
/// Read more: https://pspdfkit.com/guides/ios/current/miscellaneous/document-sharing/
...
/// This is automatically set to the range of the first document as the configuration is set
///
